...
export const METODOLOGIA_TEXTO =
  'La selección de votaciones es hecha por el usuario, no es automática ni ' +
  'exhaustiva: el análisis solo refleja las votaciones marcadas. La ' +
  '"posición de la bancada" es la opción (a favor / en contra) elegida por ' +
  'la mayoría de los miembros presentes de ese partido en esa votación; las ' +
  'abstenciones, pareos e inasistencias no fijan posición ni cuentan para el ' +
  'cálculo. La "fidelidad" mide cuántas veces un parlamentario votó igual que ' +
  'su propia bancada dentro de las votaciones seleccionadas. El PDF exportado ' +
  'incluye siempre el listado de votaciones consideradas, para que cualquier ' +
  'lector pueda verificar sobre qué base se calculó.'
